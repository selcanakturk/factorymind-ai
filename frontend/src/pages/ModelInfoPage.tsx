...
interface Props { modelInfo: ModelInfoResponse | null; loading: boolean; error: string | null; onRetry: () => void; }
...
export function ModelInfoPage({ modelInfo, loading, error, onRetry }: Props) {
